...
<body>
  ...
  .animate-wiggle {
    ...
    <div class="fixed flex flex-col bottom-0 right-1 lg:right-8 w-full z-50">
      <a href="tel:+989147281416">
        <div class="flex flex-col items-center justify-center float-right my-1 rounded-full bg-[#3490dc] px-3 py-3 lg:px-4 lg:py-4 text-sm font-bold tracking-wide text-white focus:outline-none">
          <svg class="animate-wiggle h-[35px] w-[35px] lg:h-[50px] lg:w-[50px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="https://api.whatsapp.com/send?phone=+989147281416">
        <div class="flex flex-col items-center justify-center float-right my-4  rounded-full bg-[#38a169] px-3 py-3 lg:px-4 lg:py-4 text-sm font-bold tracking-wide text-white focus:outline-none">
