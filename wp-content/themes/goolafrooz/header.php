...
<body>
  ...
  .animate-wiggle {
    ...
    <div class="fixed flex flex-col bottom-0 right-1 lg:right-8 w-full z-50">
        <a href="tel:+989147281416" class="flex flex-col h-[60px] w-[60px] lg:h-[90px] lg:w-[90px] items-center justify-center float-right my-1 rounded-full bg-[#3490dc] px-3 py-3 lg:px-4 lg:py-4 text-sm font-bold tracking-wide text-white focus:outline-none">
