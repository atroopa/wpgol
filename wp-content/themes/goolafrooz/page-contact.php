          ...
          <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
            <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
              <div class="md:5/12 lg:w-5/12">
                <!-- <img src="<?php //echo get_template_directory_uri() . '/img/contact-us/contact-us.png' 
              ...
              <div class="md:7/12 lg:w-6/12">
                ...
                <p class="mt-6 text-gray-600">ما با بهره‌گیری از دانش روز دنیا، تجهیزات مدرن و هوش مصنوعی، به دنبال ایجاد گلخانه‌هایی هوشمند و پربازده هستیم که ضمن افزایش کیفیت و کمیت محصولات، به حفظ منابع طبیعی و محیط زیست نیز کمک می‌کنند.
                  احتراما شرکا گلخانه سازی پالیز کامیاب گل افروز از سال 1384 فعالیت خود را به صورت مستمر آغاز نموده و در راستای ساخت و تجهیز صدها پروزه در سطح ملی و بین المللی فعالیت نموده است. که با شماره: 44623 در تهران بزرگ به ثبت رسیده است. شرکت گلخانه سازی گل افروز سالانه مساحتی بالغ بر 150 هکتار از اراضی مهین عزیزمان را به گلخانه های صنعتی و مدرن و هوشمند تبدیل نموده است. شرکت ما مفتخر است که همزمان با تولید تجهیزات سازه ای از مرحله ی طراحی و ساخت تا به ثمر رسیدن محصولات گلخانه با بالاترین سطح کیفی در بازارهای داخلی و خارجی فعالیت موثر و موفق داشته است. هم اکنون 36 نفر به طور مستقیم و حدودا 450 نفر به صورت غیر مستقیم در این مجموعه مشغول به کار هستند.<br>
                  <b class="font-bold"> ثبت کننده شخصیت حقوقی :</b> سازمان ثبت اسناد و املاک کشور <br>
                  <b class="font-bold"> شناسه ملی :</b> 14008592717 <br>
                  <b class="font-bold">تاریخ آخرین بروزرسانی :</b> 10/02/1402<br> 
                  <b class="font-bold"> نام شخصیت حقوقی :</b> پالیز کامیاب گل افروز <br>
                  <b class="font-bold">نوع شخصیت حقوقی :</b> شرکت با مسئولیت محدود <br>
                  <b class="font-bold">مدریت عامل حقیقی :</b> جناب آقای انور پیکار <br>
                  <b class="font-bold">شماره ثبت :</b> 44623 <br>
                  <b class="font-bold">اداره کل:</b> اداره کل ثبت اسناد و املاک استان البرز <br>
                  <b class="font-bold">واحد ثبتی:</b> اداره ثبت شرکت ها و موسسات غیر تجاری کرج <br>
                  <b class="font-bold">شعبه های شرکت گل افروز: </b><br>
                  <b class="font-bold">شعبه مرکزی :</b> استان تهران, منطقه پاسداران, خیابان دولت <br>
                  <b class="font-bold">شعبه کرج جهت مشاوره و عقد قرارداد: </b>استان البرز شهرستان کرج بخش مرکزی شهر کرج عظیمیه بلوار طالقانی شمالی – برج قائم <br>
                  <b class="font-bold"> شعبه خارج از کشور: </b> کشور عراق , اقلیم کردستان، شهر سلیمانیه, محل سرچنار, خیابان چناران, ساختمان مروف, پلاک 15 , واحد 39 <br>
